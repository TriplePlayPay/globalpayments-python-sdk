...
from python_sdk.globalpayments.api.builders.validations import Validations
...
from python_sdk.globalpayments.api.payment_methods import EBTCardData
...
class AuthorizationBuilder(TransactionBuilder):
    ...
    def with_hosted_payment_data(self, value):
        from python_sdk.globalpayments.api import ServicesContainer
