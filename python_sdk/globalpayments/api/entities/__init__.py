...
from python_sdk.globalpayments.api.payment_methods import TransactionReference
...
class Transaction(object):
    ...
    payment_facilitator_transaction_id = None
    payment_facilitator_transaction_number = None
