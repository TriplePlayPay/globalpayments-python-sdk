...
import re
from python_sdk.globalpayments.api.builders import ManagementBuilder, AuthorizationBuilder
...
class Credit(object):
    ...
    def authorize(self, amount=None):
        ...
        return (
            AuthorizationBuilder(TransactionType.Auth, self)
            .with_amount(amount)
    ...
    def charge(self, amount=None):
        ...
        return (
            AuthorizationBuilder(TransactionType.Sale, self)
            .with_amount(amount)
            .with_currency(currency)
            .with_order_id(order_id)
        )
    ...
    def tokenize(self):
        ...
        response = self.verify().with_request_multi_use_token(True).execute()
