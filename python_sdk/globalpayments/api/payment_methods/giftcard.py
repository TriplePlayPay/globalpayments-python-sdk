...
from python_sdk.globalpayments.api.entities.exceptions import ApiException
...
class GiftCard(object):
    ...
    def create(alias=None, config_name="default"):
        ...
        try:
            response = (
                gp.api.builders.AuthorizationBuilder(TransactionType.Alias, card)
    ...
    def deactivate(self):
        return gp.api.builders.AuthorizationBuilder(TransactionType.Deactivate, self)
