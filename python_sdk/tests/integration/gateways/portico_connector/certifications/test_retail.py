...
from python_sdk.tests.data import TestCards
...
class IntegrationGatewaysPorticoConnectorCertificationRetailTests(unittest.TestCase):
    """
    ...
    def test_001_card_verify_visa(self):
        ...
        if self.use_tokens:
            ...
            sale_response = (
                token.charge(15.01).with_allow_duplicates(True).execute("retail")
            )

            self.assertNotEqual(None, sale_response)
            self.assertEqual(
                "00", sale_response.response_code, sale_response.response_message
            )
    ...
    def test_002_card_verify_mastercard(self):
        ...
        if self.use_tokens:
            ...
            sale_response = (
                token.charge(15.02).with_allow_duplicates(True).execute("retail")
            )
    ...
    def test_003_card_verify_discover(self):
        ...
        if self.use_tokens:
            ...
            sale_response = (
                token.charge(15.03).with_allow_duplicates(True).execute("retail")
            )
    ...
    def test_004_card_verify_amex(self):
        ...
        if self.use_tokens:
            ...
            sale_response = (
                token.charge(15.04).with_allow_duplicates(True).execute("retail")
            )
    ...
    def test_014_charge_jcb_swipe(self):
        ...
        refund = response.refund(15.05).with_currency("USD").execute("retail")
    ...
    def test_021_charge_discover_manual_card_present(self):
        ...
        # test case 64
        reversal = response.reverse(16.07).with_auth_amount(6.07).execute("retail")

        self.assertNotEqual(None, reversal)
        self.assertEqual("00", reversal.response_code, reversal.response_message)
    ...
    def test_031_authorize_visa_swipe(self):
        ...
        self.assertEqual(
            "00", capture_response.response_code, capture_response.response_message
        )
    ...
    def test_043_charge_visa_swipe_edit_gratuity(self):
        ...
        edit_response = (
            response.edit().with_amount(18.12).with_gratuity(3.00).execute("retail")
        )

        self.assertNotEqual(None, edit_response)
        self.assertEqual(
            "00", edit_response.response_code, edit_response.response_message
        )
    ...
    def test_044_charge_mastercard_manual_edit_gratuity(self):
        ...
        edit_response = (
            response.edit().with_amount(18.13).with_gratuity(3.00).execute("retail")
        )
    ...
    def test_047a_level_ii_visa_swipe_response_b(self):
        ...
        edit_response = response.edit().with_tax_type(TaxType.NotUsed).execute("retail")
    ...
    def test_048_level_ii_visa_swipe_response_r(self):
        ...
        edit_response = (
            response.edit().with_tax_type(TaxType.TaxExempt).execute("retail")
        )
    ...
    def test_065_debit_sale_visa_swipe(self):
        card = TestCards.as_debit(
            TestCards.visa_swipe(), "32539F50C245A6A93D123412324000AA"
        )
    ...
    def test_066_debit_sale_mastercard_swipe(self):
        card = TestCards.as_debit(
            TestCards.mastercard_swipe(), "F505AD81659AA42A3D123412324000AB"
        )
    ...
    def test_081_ebtfs_purchase_visa_manual(self):
        card = TestCards.as_ebt(
            TestCards.visa_manual(False, True), "32539F50C245A6A93D123412324000AA"
        )
    ...
    def test_083_ebtfs_return_visa_swipe(self):
        card = TestCards.as_ebt(
            TestCards.visa_swipe_encrypted(), "32539F50C245A6A93D123412324000AA"
        )
    ...
    def test_086_ebt_balance_inquiry_visa_manual(self):
        card = TestCards.as_ebt(
            TestCards.visa_manual(True, True), "32539F50C245A6A93D123412324000AA"
        )
    ...
    def test_095_activate_gift_1(self):
        ...
        response = card.activate(6.00).with_currency("USD").execute("retail")
    ...
    def test_096_activate_gift_2(self):
        ...
        response = card.activate(7.00).with_currency("USD").execute("retail")
    ...
    def test_097_add_value_gift_1(self):
        ...
        response = card.add_value(8.00).with_currency("USD").execute("retail")
    ...
    def test_098_add_value_gift_2(self):
        ...
        response = card.add_value(9.00).with_currency("USD").execute("retail")
    ...
    def test_101_replace_gift_1(self):
        ...
        response = card.replace_with(TestCards.gift_card_2_manual()).execute("retail")
    ...
    def test_102_replace_gift_2(self):
        ...
        response = card.replace_with(TestCards.gift_card_1_swipe()).execute("retail")
    ...
    def test_103_sale_gift_1(self):
        ...
        response = card.charge(1.00).with_currency("USD").execute("retail")
    ...
    def test_104_sale_gift_2(self):
        ...
        response = card.charge(2.00).with_currency("USD").execute("retail")
    ...
    def test_105_sale_gift_1_void(self):
        ...
        response = card.charge(3.00).with_currency("USD").execute("retail")
    ...
    def test_106_sale_reversal_gift_2(self):
        ...
        response = card.charge(4.00).with_currency("USD").execute("retail")
